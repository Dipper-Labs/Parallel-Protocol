...
contract IssuerStorage is ExternalStorage, IIssuerStorage {
    ...
    function setDebt(bytes32 stake, address account, uint256 period, uint256 accountDebt, uint256 totalDebt, uint256 dtokens, uint256 time) external onlyManager(managerName) {
    ...
    function getDebt(bytes32 stake, address account, uint256 period) external view returns (uint256 accountDebt, uint256 totalDebt, uint256 dtokens, uint256 time) {
