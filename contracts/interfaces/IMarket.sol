...
interface IMarket {
    ...
    function addTrade(bytes32 fromSynth, uint256 fromAmount, uint256 fromSynthPrice, bytes32 toSynth, uint256 toAmount, uint256 toSynthPirce) external;
    ...
    function getAssetMarket(bytes32 asset) external view returns (uint256 open, uint256 low, uint256 hight, uint256 volume, uint256 turnover);
